...
define( 'THE_ANOTHER_SEO_VERSION', '1.2.1' );
...
if ( file_exists( THE_ANOTHER_SEO_PLUGIN_DIR . 'includes/indexable-functions.php' ) ) {
	require_once THE_ANOTHER_SEO_PLUGIN_DIR . 'includes/indexable-functions.php';
}
